...
export const createJobSchema = z.object({
  ...
  lora_name: z.string().optional(),
  lora_scale: z.number().min(0).max(3).optional(),
  lora_revision: z.string().optional(),
  mode: z.enum(["normal", "hybrid"]).optional(),
  vocal_volume: z.number().min(0).max(2).optional(),
  instrumental_volume: z.number().min(0).max(2).optional(),
  ...
  enhance_mode: z.enum(["enhance", "denoise"]).optional(),
});
